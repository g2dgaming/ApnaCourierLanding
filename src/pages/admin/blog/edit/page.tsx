      ...
      <Unauthenticated>
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">You need to be signed in to edit blog posts.</p>
...
function EditBlogPostPageInner() {
  ...
  const updateMutation = useMutation(api.blog.update);
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Empty>
            ...
            <EmptyContent>
              <Button onClick={() => navigate("/admin/blog")}>Back to Blog</Button>
            </EmptyContent>
          </Empty>
        </div>
      </div>
